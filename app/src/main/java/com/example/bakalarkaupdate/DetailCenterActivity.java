...
public class DetailCenterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.detailCenterLayout), (v, insets) -> {
...
//        centerNameString = getIntent().getStringExtra("centerName");
//
//
//        tvDetailCenterName = findViewById(R.id.tvDetailCenterName);
